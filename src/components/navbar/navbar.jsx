      ...
      <nav className="navbar navbar-expand-lg  ">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">
            <h2 style={{fontfamily: 'toyor-aljanah', color: 'rgb(131 219 255/1)'}}> Mohamed <img style={{ width: '35px' }} src="https://img.icons8.com/fluency/48/source-code.png" alt="logo" /> </h2>
          </Link>
